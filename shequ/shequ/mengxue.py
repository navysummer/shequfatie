...
class Mengxue(object):
    def __init__(self, user,password,url='http://mx.dkln.top'):
        self.user = user
        ...
        self.headers = {
            ...
            "Host": "mx.dkln.top",
            "Referer": "http://mx.dkln.top/login/login.aspx",
    ...
    def fatie(self,title,content):
        fatie_url = self.url+'/bbs/topic_add.aspx?id=5358'
        fatie_data = {
            'name':title,
            'namea': 0,
