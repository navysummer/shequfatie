...
class Hongchen(object):
    def __init__(self,user,password,url='http://n.cidv.cn'):
        self.user = user
        ...
        self.headers = {
            ...
            "Host": "n.cidv.cn",
            "Referer": "http://n.cidv.cn/bbs/index.aspx",
    ...
    def fatie(self,title,content):
        fatie_url = self.url+'/bbs/topic_add.aspx?id=5251'
        fatie_data = {
            'name':title,
            'namea':0,
            'pxa':'',
